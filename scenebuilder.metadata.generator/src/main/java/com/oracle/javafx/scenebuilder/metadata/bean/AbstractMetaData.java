...
//    private String category;
     ...
     */
    protected AbstractMetaData(Resources resource, String name) {
    	 this.bundle = resource;
    	 this.name = name;
    }

    public String getBundleValue(Class<?> beanClass, String name, String defaultValue) {
    	return bundle.get(beanClass, this.name + "." + name, defaultValue);
    }

    public void setBundleValue(Class<?> beanClass, String name, String value) {
    	bundle.set(beanClass, this.name + "." + name, value);
    }

    public String getBundleValue(Class<?> beanClass, String prefix, String name, String defaultValue) {
    	return bundle.get(beanClass, (prefix == null ? "" : prefix + ".") + this.name + "." + name, defaultValue);
    }

    public void setBundleValue(Class<?> beanClass, String prefix, String name, String value) {
    	bundle.set(beanClass, (prefix == null ? "" : prefix + ".") + this.name + "." + name, value);
    }
