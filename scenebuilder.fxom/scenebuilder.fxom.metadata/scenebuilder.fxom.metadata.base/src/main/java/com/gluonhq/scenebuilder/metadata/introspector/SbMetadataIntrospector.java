...
import com.gluonhq.scenebuilder.metadata.property.value.BooleanPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.DoublePropertyMetadata.CoordinateDoublePropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.DurationPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.EnumerationPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.EventHandlerPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.FontPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.ImagePropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.IntegerPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.StringPropertyMetadata.I18nStringPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.list.StringListPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.paint.ColorPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.property.value.paint.PaintPropertyMetadata;
import com.gluonhq.scenebuilder.metadata.util.SBDuration;
